const { registerUser, addLead, getLeadsByMonth, getSources, getPriorityByMonth, getStatusByMonth, getFollowUpsDayWiseOfEachUser } = require('../controller/adminController');
